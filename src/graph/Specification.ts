...
export class ValueFactory {
    ...
    buildValue<TValue extends Value>(json: AstJson): TValue {
        ...
        const rule =
            this.specification.valueRules.find((r) => this.matchRule(r.types, identifier)) || this.defaultValueRule;
    ...
    buildType<TType extends Type>(json: AstJson): TType {
        ...
        const rule =
            this.specification.typeRules.find((r) => this.matchRule(r.types, identifier)) || this.defaultTypeRule;
